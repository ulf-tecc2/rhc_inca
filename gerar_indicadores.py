...
def insere_indicador_invalidos(df, response):
    ...
    q_TNM = df_apos_analise[
        (df_apos_analise["_AnaliseTNM"] == "incompleto")
        | (df_apos_analise["_AnaliseTNM"] == "demais")
    ].shape[0]

    q_LOCTUDET = df_apos_analise[
        (df_apos_analise["_AnaliseLOCTUDET"] == "incompleto")
        | (df_apos_analise["_AnaliseLOCTUDET"] == "demais")
    ].shape[0]

    q_LOCTUPRI = df_apos_analise[
        (df_apos_analise["_AnaliseLOCTUPRI"] == "incompleto")
        | (df_apos_analise["_AnaliseLOCTUPRI"] == "demais")
    ].shape[0]

    q_LOCTUPRO = df_apos_analise[
        (df_apos_analise["_AnaliseLOCTUPRO"] == "incompleto")
        | (df_apos_analise["_AnaliseLOCTUPRO"] == "demais")
    ].shape[0]

    q_ESTADIAM = df_apos_analise[
        (df_apos_analise["_AnaliseESTADIAM"] == "incompleto")
        | (df_apos_analise["_AnaliseESTADIAM"] == "demais")
    ].shape[0]
