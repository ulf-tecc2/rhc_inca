...
def main(df):
    ...
    df_unico, df_result = trocar_valores_invalidos_para_nulos(df_unico)
    ...
    df_unico, df_result_aux = analisa_TNM_PTNM(df_unico , nome_variavel = "TNM")
    df_result = pd.concat([df_result, df_result_aux], axis=1)
    print(
        log.logar_acao_realizada("Analise de valores", f"Analisar o valor de TNM", "")
    )
    
    df_unico, df_result_aux = analisa_TNM_PTNM(df_unico , nome_variavel = "PTNM")
    df_result = pd.concat([df_result, df_result_aux], axis=1)
    print(
        log.logar_acao_realizada("Analise de valores", f"Analisar o valor de TNM", "")
    )
